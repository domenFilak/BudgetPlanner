	...
	<body>
		<?php
			...
			if (isset($_POST) && isset($_POST["insert_posodobi"])) {
				...
				if ($TransactionDate != null && $TransactionPlusORMinus != null && $TransactionAmount != null && $TransactionInfo != null) {
				
					$TransactionPlusORMinusCon = convertPlusOrMinus($TransactionPlusORMinus);
				
					dbUpdateTransaction($db, $TransactionID, $TransactionDate, $TransactionPlusORMinusCon, $TransactionAmount, $TransactionInfo);
					redirect("main.php");
				}
				else {
